<%-- 
    Document   : checkout
    Created on : Mar 24, 2023, 7:45:27 AM
    Author     : admin
--%>
...
<html class="no-js" lang="en">
    <jsp:include page="layout/menu.jsp"/></br></br>
    <body>
                            ...
                            <div class="col-lg-5 col-md-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-20">
                                        ...
                                        <input  value="${sessionScope.User.user_name}" type="text">
                                    </div>
                                    <div class="col-lg-12 mb-20">
                                        <label> Email <span>*</span></label>
                                        <input  value="${sessionScope.User.user_email}" type="text">
                                    </div>
                                    <div class="col-lg-12 mb-20">
