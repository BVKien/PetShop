<%-- 
    Document   : cart
    Created on : Mar 17, 2023, 5:04:39 PM
    Author     : admin
--%>
...
<html lang="en">
    ...
    <jsp:include page="/layout/menu.jsp"/></br></br></br>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="cart_product_img">
                                                    <a href="#"><img src="images/PH01.png" alt="Product" width="200px" height="200px"></a>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="cart_product_img">
                                                    <a href="#"><img src="images/PH02.png" alt="Product" width="200px" height="200px"></a>
                                                </td>
                                                <td class="cart_product_desc">
                                            ...
                                            <tr>
                                                <td class="cart_product_img">
                                                    <a href="#"><img src="images/PH03.png" alt="Product" width="200px" height="200px"></a>
                                                </td>
                                                <td class="cart_product_desc">
                                                    <h5>Minimal Plant Pot</h5>
                                                </td>
